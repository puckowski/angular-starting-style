...
export class FormsModule {
    ...
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.2.0-next.0+sha-2360a89-with-local-changes", ngImport: i0, type: FormsModule, declarations: [i1.NgModel, i2.NgModelGroup, i3.NgForm], exports: [InternalFormsSharedModule, i1.NgModel, i2.NgModelGroup, i3.NgForm] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.2.0-next.0+sha-2360a89-with-local-changes", ngImport: i0, type: FormsModule, imports: [InternalFormsSharedModule] }); }
}
...
export class ReactiveFormsModule {
    ...
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.2.0-next.0+sha-2360a89-with-local-changes", ngImport: i0, type: ReactiveFormsModule, imports: [InternalFormsSharedModule] }); }
}
